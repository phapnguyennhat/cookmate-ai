...
export const OPEN_MODEL_AI = 'deepseek/deepseek-chat-v3-0324:free'
export const GURU_MODEL_AI = 'sdxl'


export const GENERATE_RECIPE_OPTION_PROMPT =
  ':Depends on user instruction create 3 different Recipe varient with Recipe Name with Emoji, 2 line description and main ingredient list in JSON format with field recipeName, description, ingredients (without size) only, only json not any else.';
...
//   - Give me category List for recipe from []
