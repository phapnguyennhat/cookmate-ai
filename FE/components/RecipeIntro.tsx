        ...
        <View>
            ...
            <View className=' mt-[15px] flex-row  justify-between gap-[5px] '>
                <View className=' flex-row items-center gap-[7px] p-[10px] rounded-[15px] bg-secondary' >
                    ...
                    <View>
                        <Text className=' font-outfit text-lg text-primary' >{recipe?.calories} Cal</Text>
                        <Text>Calories</Text>
                    </View>
                </View>
                ...
                <View className=' flex-row items-center gap-[7px] p-[10px] rounded-[15px] bg-secondary' >
                    ...
                    <View>
                        <Text className=' font-outfit text-lg text-primary' >{recipe?.cookTime} Minute</Text>
                        <Text>Time</Text>
                    </View>
                </View>
                ...
                <View className=' flex-row items-center gap-[7px] p-[10px] rounded-[15px] bg-secondary' >
                    ...
                    <View>
                        <Text className=' font-outfit text-lg text-primary' >{recipe?.serveTo} Serve</Text>
                        <Text>Serve</Text>
                    </View>
                </View>
            </View>
